...
public final class JavaAdapter implements IdFunctionCall
{
										   ...
										   String scriptClassName)
	{
		ClassFileWriter cfw = new ClassFileWriter(adapterName,
				superClass.getName(),
				"<adapter>");
		cfw.addField("factory", "Ldev/latvian/mods/rhino/ContextFactory;",
				(short) (ClassFileWriter.ACC_PUBLIC |
						ClassFileWriter.ACC_FINAL));
		cfw.addField("delegee", "Ldev/latvian/mods/rhino/Scriptable;",
				(short) (ClassFileWriter.ACC_PUBLIC |
						ClassFileWriter.ACC_FINAL));
		cfw.addField("self", "Ldev/latvian/mods/rhino/Scriptable;",
				(short) (ClassFileWriter.ACC_PUBLIC |
						ClassFileWriter.ACC_FINAL));
									 ...
									 String superName, Constructor<?> superCtor)
	{
		...
		if (parameters.length == 0)
		{
			cfw.startMethod("<init>",
					"(Ldev/latvian/mods/rhino/Scriptable;"
							+ "Ldev/latvian/mods/rhino/ContextFactory;)V",
		...
		else
		{
			StringBuilder sig = new StringBuilder(
					"(Ldev/latvian/mods/rhino/Scriptable;"
							+ "Ldev/latvian/mods/rhino/ContextFactory;");
										  ...
										  String scriptClassName)
	{
		...
		cfw.addInvoke(ByteCode.INVOKESTATIC,
				"dev/latvian/mods/rhino/JavaAdapter",
				"runScript",
				"(Ldev/latvian/mods/rhino/Script;"
						+ ")Ldev/latvian/mods/rhino/Scriptable;");
