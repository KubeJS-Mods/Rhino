...
public class ByteCode {
	 ...
	 */
	public static final byte MH_GETFIELD = 1, MH_GETSTATIC = 2, MH_PUTFIELD = 3, MH_PUTSTATIC = 4, MH_INVOKEVIRTUAL = 5, MH_INVOKESTATIC = 6, MH_INVOKESPECIAL = 7, MH_NEWINVOKESPECIAL = 8, MH_INVOKEINTERFACE = 9;
}